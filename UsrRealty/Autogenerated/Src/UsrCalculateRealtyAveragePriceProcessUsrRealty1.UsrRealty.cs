namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateRealtyAveragePriceProcessUsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateRealtyAveragePriceProcessUsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrCalculateRealtyAveragePriceProcessUsrRealty1MethodsWrapper(Process process)
			: base(process) {
